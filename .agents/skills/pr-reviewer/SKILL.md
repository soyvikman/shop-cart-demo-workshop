...
name: pr-reviewer
description: >
  Use this skill when the developer asks to review their code changes, apply corrections, commit, push, or open a Pull Request toward the upstream repository. Handles the full cycle: diff analysis, code review, optional fixes, conventional commit, and PR creation via GitHub MCP.
---
# PR Reviewer
