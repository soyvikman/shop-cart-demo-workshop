...
name: pr-reviewer
description: >
  Usa esta skill cuando el usuario te pida revisar sus cambios de código, aplicar correcciones, hacer commit, push o abrir un Pull Request hacia el repositorio original (upstream). Maneja el ciclo completo: análisis de diff, revisión de código, correcciones opcionales, commit con Conventional Commits y creación de PR mediante GitHub MCP.
---
# PR Reviewer
